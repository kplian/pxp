CREATE OR REPLACE FUNCTION orga.f_get_fechas_ini_historico (
  ...
  BEGIN
    ...
    select fecha_asignacion, ha.fecha_finalizacion
            ...
            where ha.estado_reg = ''activo'' and ha.id_funcionario = '||p_id_funcionario||' and tcon.id_tipo_contrato in (1,4) and ha.tipo = ''oficial''
