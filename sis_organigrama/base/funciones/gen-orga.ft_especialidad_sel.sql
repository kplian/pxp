CREATE OR REPLACE FUNCTION "orga"."ft_especialidad_sel"(	
				p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying)
RETURNS character varying AS
$BODY$
/**************************************************************************
 SISTEMA:		Organigrama
 FUNCION: 		orga.ft_especialidad_sel
...
BEGIN
	...
	v_nombre_funcion = 'orga.ft_especialidad_sel';
	...
	if(p_transaccion='OR_esp_niv_SEL')then
    	...
    	begin
			...
			v_consulta:='select
						...
						from orga.tespecialidad esp_niv
