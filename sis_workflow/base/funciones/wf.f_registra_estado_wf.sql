...
***************************************************************************
 ...
 FECHA:            11/03/2013
    ...
    #144 EndeEtr    05/06/202       EGS                     Se modifica la asignacion de parametros solo toma los parametros ya sea
                                                            mandado por funcion o consultando la parametrizacion del estado
***************************************************************************/
DECLARE
...
BEGIN
    ...
    if(v_registros.alerta = 'si' and  (p_id_funcionario is not NULL or  p_id_depto is not NULL )) THEN
            ...
            */
            END IF;
            --#144
            IF p_clase = '' and  v_registros.nombre_clase_alerta is not NULL and v_registros.nombre_clase_alerta != '' THEN

                 p_clase = v_registros.nombre_clase_alerta;

            END IF;
            IF p_parametros = '' and  v_registros.parametros_ad is not NULL and v_registros.parametros_ad != '' THEN
            ...
            END IF;
            IF p_tipo = '' and  v_registros.tipo_noti is not NULL and v_registros.tipo_noti != '' THEN
