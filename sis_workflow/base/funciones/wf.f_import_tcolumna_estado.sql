...
BEGIN	 
    ...
    from wf.ttabla ta    
    where ta.bd_codigo_tabla = p_codigo_tabla and ta.estado_reg = 'activo' and
    	ta.id_tipo_proceso = v_id_tipo_proceso;
        
    select id_tipo_columna into v_id_tipo_columna
    from wf.ttipo_columna tc    
    where tc.bd_nombre_columna = p_nombre_tipo_columna and tc.estado_reg = 'activo' and
    ...
    where ce.id_tipo_columna = v_id_tipo_columna and ce.id_tipo_estado = v_id_tipo_estado AND
    ...
    if (p_accion = 'delete') then
    	...
    	where estado_reg = 'activo' and id_columna_estado = v_id_columna_estado;
    else
