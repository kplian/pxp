...
?>
<script>
Phx.vista.EstadoWf=Ext.extend(Phx.frmInterfaz,{
    ActSave:'../../sis_workflow/control/DocumentoWf/subirArchivoWf',
    
    constructor:function(config)
    {   
        Phx.vista.EstadoWf.superclass.constructor.call(this,config);
    ...
    {        
        Phx.vista.EstadoWf.superclass.loadValoresIniciales.call(this);
    ...
    onSubmit:function(){
        console.log('save antes del formulario');
        this.fireEvent('save');
