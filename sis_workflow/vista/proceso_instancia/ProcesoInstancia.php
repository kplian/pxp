...
Phx.vista.ProcesoInstancia = Ext.extend(Phx.gridInterfaz,{
        ...
        constructor:function(config) {
            ...
            console.log('this.configProceso[this.config.indice]' , this.configProceso[this.config.indice])
            this.historico = 'no';
            ...
            console.log('this.store.baseParams   ===> ', this.store.baseParams)

            if (this.configProceso[this.config.indice].atributos.vista_tipo == 'detalle-modal') {
        ...
        loadValoresIniciales:function()
        {
            ...
            if (this.configProceso[this.config.indice].atributos.vista_tipo != 'maestro') {
                console.log(' ++++++++++++++++++++++++++++++++++++++++++++++++')
                console.log('this.config.indice' , this.config.indice)
                console.log('this.configProceso[this.config.indice].atributos', this.configProceso[this.config.indice].atributos)

                console.log('this.configProceso[this.config.indice].atributos.vista_campo_maestro', this.configProceso[this.config.indice].atributos.vista_campo_maestro)
        ...
        armaOrdenacionyOtros : function() {
            ...
            console.log('================================================')
            console.log('=== armaOrdenacionyOtros this.sortInfo' , this.sortInfo)
            console.log('================================================')
            ...
            for (var i = 0 ;i < this.configProceso[this.config.indice].columnas.length; i++) {
                ...
                if (this.configProceso[this.config.indice].columnas[i].momento != 'ninguno') {
                    ...
                    if (this.configProceso[this.config.indice].columnas[i].form_sobreescribe_config != '' && 
                        ...
                        console.log('form_sobreescribe_config' , this.configProceso[this.config.indice].columnas[i].form_sobreescribe_config)
                        ...
                        //rAC 2023 descomentar esta linea
        ...
        addStoreField : function (config_columna) {
            ...
            //si es timepstamp  RAC 2023
            if (config_columna.bd_tipo_columna == 'time' ) {
                this.fields.push({name: config_columna.bd_nombre_columna,
                    type: 'string', dateFormat:'H:i:s'}); //H:i:s.u    | g:i A  H:i:s
            }
       ...
       successSave : function(resp){
        ...
        onReloadPage:function(m){       
            ...
            parametros[this.configProceso[this.config.indice].atributos.vista_campo_maestro] = this.maestro[this.configProceso[this.config.indice].atributos.vista_campo_maestro];
            const sortVar = this.configProceso[this.config.indice].atributos.vista_campo_ordenacion;
            this.store.setDefaultSort( sortVar , 'DESC' )
