...
class MODTabla extends MODbase{
    ...
    function listarTablaCombo(){
                ...
                //Definicion de la lista del resultado del query
                $this->captura('id_' . $_SESSION[$nombreSess]['atributos']['bd_nombre_tabla'],'int4');
                
                if ($_SESSION[$nombreSess]['atributos']['vista_tipo'] == 'maestro') {
                ...
                foreach ($_SESSION[$nombreSess]['columnas'] as $value) {
        ...
        function listarTablaInstancia(){
                ...
                //echo "estado". '_wf_ins_'.$this->objParam->getParametro('tipo_proceso').'_'.$this->objParam->getParametro('tipo_estado');
                //exit;
                $Cols = $_SESSION[$nombreSess]['columnas'];
                //var_dump($Cols);exit;
                //var_dump($Cols);exit;
        ...
        function insertarTablaInstancia(){
                ...
                if ($_SESSION[$nombreSess]['atributos']['vista_tipo'] != 'maestro') {
                    $this->setParametro($_SESSION[$nombreSess]['atributos']['vista_campo_maestro'], $_SESSION[$nombreSess]['atributos']['vista_campo_maestro'],'integer');
                }
                //Define los parametros para la funcion                
                foreach ($_SESSION[$nombreSess]['columnas'] as $value) {
