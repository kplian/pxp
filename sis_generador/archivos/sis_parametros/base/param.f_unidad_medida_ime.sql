...
BEGIN
	...
	***********************************/
	...
	if(p_transaccion='PM_UME_INS')then
        ...
        begin
			...
			v_resp = f_agrega_clave(v_resp,'mensaje','Unidad de Medida almacenado(a) con exito (id_unidad_medida'||v_id_unidad_medida||')'); 
            v_resp = f_agrega_clave(v_resp,'id_unidad_medida',v_id_unidad_medida::varchar);
	...
	***********************************/
		...
		begin
			...
			--Definicion de la respuesta
            v_resp = f_agrega_clave(v_resp,'mensaje','Unidad de Medida modificado(a)'); 
            v_resp = f_agrega_clave(v_resp,'id_unidad_medida',v_parametros.id_unidad_medida::varchar);
	...
	***********************************/
		...
		begin
            ...
            --Definicion de la respuesta
            v_resp = f_agrega_clave(v_resp,'mensaje','Unidad de Medida eliminado(a)'); 
            v_resp = f_agrega_clave(v_resp,'id_unidad_medida',v_parametros.id_unidad_medida::varchar);
...
COST 100;
ALTER FUNCTION "param"."f_unidad_medida_ime"(integer, integer, character varying, character varying) OWNER TO postgres;
