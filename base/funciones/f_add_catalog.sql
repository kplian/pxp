...
CREATE OR REPLACE FUNCTION pxp.f_add_catalog(p_codigo_subsistema character varying, p_catalogo_tipo character varying, p_catalogo character varying)
...
BEGIN
    ...
    id_usuario_reg, estado_reg, descripcion, id_catalogo_tipo
    ) values(
    1, 'activo', p_catalogo, v_id_catalogo_tipo
    );
