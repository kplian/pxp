...
class ACTConceptoIngas extends ACTbase{
    ...
    function listarConceptoIngas(){
        ...
        if($this->objParam->getParametro('id_concepto_ingas_agrupador')!=''){//#
            $this->objParam->addFiltro("conig.id_concepto_ingas_agrupador =".$this->objParam->getParametro('id_concepto_ingas_agrupador'));
        }
