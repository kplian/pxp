...
***************************************************************************
 ...
 #131     ETR       13/04/2020        RAC KPLIAN         Validación de tipo de cambio que exista antes de  querer hacer conversiones
...
BEGIN
    ...
    --#131 valida la exisencia de tipo de cambio
    ...
    if(v_id_moneda_base=v_id_moneda_1)then
        ...
        IF  v_registro IS NULL THEN
           raise exception 'No existe un registro para el tipo de cambio de las  monedas involucradas';
        END IF;
