...
BEGIN
  ...
  ***********************************/
	...
	/*********************************
 	#TRANSACCION:  'PM_PUSHNOT_SEL'
 	#DESCRIPCION:	Devuelve los push notifications de usuarios registrados que no fuerno enviados
 	#AUTOR:		rac
 	#FECHA:		11/04/2016 11:59:10
	***********************************/
	elseif(p_transaccion='PM_PUSHNOT_SEL')then --#0
		begin
			-- Sentencia de la consulta
			v_consulta:='WITH updated AS (
						UPDATE param.talarma
						SET estado_notificacion = ''enviada''
						FROM segu.tpnotification_device pnd
