-- Function: param.f_tproveedor_sel(integer, integer, character varying, character varying)

-- DROP FUNCTION param.f_tproveedor_sel(integer, integer, character varying, character varying);

CREATE OR REPLACE FUNCTION param.f_tproveedor_sel(p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION param.f_tproveedor_sel(integer, integer, character varying, character varying) OWNER TO postgres;
