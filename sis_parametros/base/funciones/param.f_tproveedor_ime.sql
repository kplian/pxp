...
***************************************************************************
 HISTORIAL DE MODIFICACIONES:
   ...
   #47          20/08/2019  EGS             Se agrega cmp id_auxiliar
***************************************************************************/
    ...
    ***********************************/
    ...
    if(p_transaccion='PM_PROVEE_INS')then
        ...
        begin
           ...
           v_codigo_auxiliar = null;--#47
           --#47Verificamos si la insercion se hace por auxiliar
           IF EXISTS (
                       SELECT 1
                ...
                WHERE aux.id_auxiliar = v_parametros.id_auxiliar ;

            END IF;

            --#47no_registered   cuando se registra al especificar los datos del la institucion
            --before_registered cuando se registra por  al especificar una institucion  por el combo
            ...
            IF EXISTS (
                      ...
                      IF  exists(select
                          ...
                          where      a.estado_reg = 'activo'
                                and  upper(a.codigo_auxiliar) = upper(v_codigo_gen) and v_codigo_auxiliar is NULL) THEN --#47
                      ...
                      IF   v_codigo_auxiliar is null  THEN --#47
                       ...
                       ELSEIF v_codigo_auxiliar is not null THEN   --#47
                          v_id_auxiliar = v_parametros.id_auxiliar;
                       END IF;
