...
CREATE OR REPLACE FUNCTION param.ft_variable_global_sel(p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying)
  RETURNS character varying AS
$BODY$
/**************************************************************************
 SISTEMA:		Parametros Generales
 FUNCION: 		param.ft_variable_global
...
BEGIN
	...
	/*********************************    
 	#TRANSACCION:  'PM_VARGLO_SEL'
 	#DESCRIPCION:	Consulta de datos
 	#AUTOR:		admin	
 	#FECHA:		16-08-2012 23:48:42
	***********************************/

	if(p_transaccion='PM_VARGLO_SEL')then
	...
	/*********************************    
 	#TRANSACCION:  'PM_VARGLO_CONT'
 	#DESCRIPCION:	Conteo de registros
 	#AUTOR:		admin	
 	#FECHA:		16-08-2012 23:48:42
	***********************************/

	elsif(p_transaccion='PM_VARGLO_CONT')then
