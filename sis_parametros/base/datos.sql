...
select pxp.f_insert_tprocedimiento ('PM_DEPUSU_ELI', 'Eliminacion de registros
', 'si', '', '', 'param.f_tdepto_usuario_ime');
select pxp.f_insert_tprocedimiento ('PM_DEPUSU_MOD', 'Modificacion de registros
', 'si', '', '', 'param.f_tdepto_usuario_ime');
select pxp.f_insert_tprocedimiento ('PM_DEPUSU_INS', 'Insercion de registros
', 'si', '', '', 'param.f_tdepto_usuario_ime');
select pxp.f_insert_tprocedimiento ('PM_PRITSE_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.f_proveedor_item_servicio_ime');
select pxp.f_insert_tprocedimiento ('PM_PRITSE_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.f_proveedor_item_servicio_ime');
select pxp.f_insert_tprocedimiento ('PM_PRITSE_INS', '	Insercion de registros
 	', 'si', '', '', 'param.f_proveedor_item_servicio_ime');
select pxp.f_insert_tprocedimiento ('PM_PACATI_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.ft_catalogo_tipo_ime');
select pxp.f_insert_tprocedimiento ('PM_PACATI_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.ft_catalogo_tipo_ime');
select pxp.f_insert_tprocedimiento ('PM_PACATI_INS', '	Insercion de registros
 	', 'si', '', '', 'param.ft_catalogo_tipo_ime');
select pxp.f_insert_tprocedimiento ('PM_PROVEE_ELI', 'Eliminacion de registros
', 'si', '', '', 'param.f_tproveedor_ime');
select pxp.f_insert_tprocedimiento ('PM_PROVEE_MOD', 'Modificacion de registros
', 'si', '', '', 'param.f_tproveedor_ime');
select pxp.f_insert_tprocedimiento ('PM_PROVEE_INS', 'Insercion de registros
', 'si', '', '', 'param.f_tproveedor_ime');
select pxp.f_insert_tprocedimiento ('PM_PRO_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.f_tpm_proyecto_sel');
select pxp.f_insert_tprocedimiento ('PM_PRO_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.f_tpm_proyecto_sel');
select pxp.f_insert_tprocedimiento ('PM_UME_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.f_unidad_medida_sel');
select pxp.f_insert_tprocedimiento ('PM_UME_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.f_unidad_medida_sel');
select pxp.f_insert_tprocedimiento ('PM_CONALA_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.ft_config_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_CONALA_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.ft_config_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_CONALA_INS', '	Insercion de registros
 	', 'si', '', '', 'param.ft_config_alarma_ime');
...
select pxp.f_insert_tprocedimiento ('PM_PACATI_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_catalogo_tipo_sel');
select pxp.f_insert_tprocedimiento ('PM_PACATI_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_catalogo_tipo_sel');
...
select pxp.f_insert_tprocedimiento ('PM_INSTIT_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_institucion_sel');
select pxp.f_insert_tprocedimiento ('PM_INSTIT_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_institucion_sel');
select pxp.f_insert_tprocedimiento ('PM_UME_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.f_unidad_medida_ime');
select pxp.f_insert_tprocedimiento ('PM_UME_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.f_unidad_medida_ime');
select pxp.f_insert_tprocedimiento ('PM_UME_INS', '	Insercion de registros
 	', 'si', '', '', 'param.f_unidad_medida_ime');
select pxp.f_insert_tprocedimiento ('PM_CATCMB_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_catalogo_sel');
select pxp.f_insert_tprocedimiento ('PM_CATCMB_SEL', '	Listado de los catálogos para combos
 	', 'si', '', '', 'param.ft_catalogo_sel');
select pxp.f_insert_tprocedimiento ('PM_CAT_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_catalogo_sel');
select pxp.f_insert_tprocedimiento ('PM_CAT_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_catalogo_sel');
select pxp.f_insert_tprocedimiento ('PM_GENALA_INS', '	Revisa alaramas del sistema SAJ
 	', 'si', '', '', 'param.ft_dispara_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_CAT_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.ft_catalogo_ime');
select pxp.f_insert_tprocedimiento ('PM_CAT_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.ft_catalogo_ime');
select pxp.f_insert_tprocedimiento ('PM_CAT_INS', '	Insercion de registros
 	', 'si', '', '', 'param.ft_catalogo_ime');
select pxp.f_insert_tprocedimiento ('PM_PRITSE_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.f_proveedor_item_servicio_sel');
select pxp.f_insert_tprocedimiento ('PM_PRITSE_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.f_proveedor_item_servicio_sel');
select pxp.f_insert_tprocedimiento ('PM_SERVIC_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.f_servicio_ime');
select pxp.f_insert_tprocedimiento ('PM_SERVIC_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.f_servicio_ime');
select pxp.f_insert_tprocedimiento ('PM_SERVIC_INS', '	Insercion de registros
 	', 'si', '', '', 'param.f_servicio_ime');
select pxp.f_insert_tprocedimiento ('PM_GESTIO_ELI', '	Inactiva la gestion selecionada
', 'si', '', '', 'param.ft_gestion_ime');
...
', 'si', '', '', 'param.ft_gestion_ime');
select pxp.f_insert_tprocedimiento ('PM_PRO_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.f_tpm_proyecto_ime');
select pxp.f_insert_tprocedimiento ('PM_PRO_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.f_tpm_proyecto_ime');
select pxp.f_insert_tprocedimiento ('PM_PRO_INS', '	Insercion de registros
 	', 'si', '', '', 'param.f_tpm_proyecto_ime');
select pxp.f_insert_tprocedimiento ('PM_LUG_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.ft_lugar_ime');
select pxp.f_insert_tprocedimiento ('PM_LUG_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.ft_lugar_ime');
select pxp.f_insert_tprocedimiento ('PM_LUG_INS', '	Insercion de registros
 	', 'si', '', '', 'param.ft_lugar_ime');
select pxp.f_insert_tprocedimiento ('PM_DOCUME_ELI', '	Inactiva el documento selecionado
', 'si', '', '', 'param.ft_documento_ime');
...
', 'si', '', '', 'param.ft_documento_ime');
select pxp.f_insert_tprocedimiento ('PM_INSTIT_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.ft_institucion_ime');
select pxp.f_insert_tprocedimiento ('PM_INSTIT_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.ft_institucion_ime');
select pxp.f_insert_tprocedimiento ('PM_INSTIT_INS', '	Insercion de registros
 	', 'si', '', '', 'param.ft_institucion_ime');
select pxp.f_insert_tprocedimiento ('PM_PERIOD_ELI', '	Inactiva la periodo selecionada
', 'si', '', '', 'param.ft_periodo_ime');
...
select pxp.f_insert_tprocedimiento ('PM_DISALARM_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_dispara_alarma_sel');
select pxp.f_insert_tprocedimiento ('PM_DISALARM_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_dispara_alarma_sel');
select pxp.f_insert_tprocedimiento ('PM_PROVEEV_CONT', '	Conteo de registros de proveedores en la vista vproveedor
 	', 'si', '', '', 'param.f_tproveedor_sel');
select pxp.f_insert_tprocedimiento ('PM_PROVEEV_SEL', '	Consulta de datos de proveedores a partir de una vista de base
                    de datos
 	', 'si', '', '', 'param.f_tproveedor_sel');
select pxp.f_insert_tprocedimiento ('PM_PROVEE_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.f_tproveedor_sel');
select pxp.f_insert_tprocedimiento ('PM_PROVEE_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.f_tproveedor_sel');
select pxp.f_insert_tprocedimiento ('PM_SERVIC_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.f_servicio_sel');
select pxp.f_insert_tprocedimiento ('PM_SERVIC_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.f_servicio_sel');
select pxp.f_insert_tprocedimiento ('PM_DOCUME_CONT', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'param.ft_documento_sel');
select pxp.f_insert_tprocedimiento ('PM_DOCUME_SEL', '	Listado de documentos
', 'si', '', '', 'param.ft_documento_sel');
select pxp.f_insert_tprocedimiento ('PM_ALARM_ELI', '	Eliminacion de registros
 	', 'si', '', '', 'param.ft_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_DESCCOR_MOD', '	DEsactiva envio de correos
 	', 'si', '', '', 'param.ft_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_ALARM_MOD', '	Modificacion de registros
 	', 'si', '', '', 'param.ft_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_ALARM_INS', '	Insercion de registros
 	', 'si', '', '', 'param.ft_alarma_ime');
select pxp.f_insert_tprocedimiento ('PM_ALARM_PEND', '	Cuenta cuantas alarmas tiene pendientes el funcionario
 	', 'si', '', '', 'param.ft_alarma_sel');
select pxp.f_insert_tprocedimiento ('PM_ALARM_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_alarma_sel');
select pxp.f_insert_tprocedimiento ('PM_ALARM_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_alarma_sel');
select pxp.f_insert_tprocedimiento ('PM_ALARMCOR_SEL', '	Consulta de alarmas pendientes de envio de correo no se utiliza con pagiancion
 	', 'si', '', '', 'param.ft_alarma_sel');
select pxp.f_insert_tprocedimiento ('PM_LUG_CONT', '	Conteo de registros
 	', 'si', '', '', 'param.ft_lugar_sel');
select pxp.f_insert_tprocedimiento ('PM_LUG_ARB_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_lugar_sel');
select pxp.f_insert_tprocedimiento ('PM_LUG_SEL', '	Consulta de datos
 	', 'si', '', '', 'param.ft_lugar_sel');
select pxp.f_insert_tprocedimiento ('PM_MONEDA_ELI', '	Inactiva la moneda selecionada
', 'si', '', '', 'param.ft_moneda_ime');
...
', 'si', '', '', 'param.ft_moneda_ime');
select pxp.f_insert_tprocedimiento ('PM_DEPUSU_CONT', 'Conteo de registros
', 'si', '', '', 'param.f_tdepto_usuario_sel');
select pxp.f_insert_tprocedimiento ('PM_DEPUSU_SEL', 'Consulta de datos
', 'si', '', '', 'param.f_tdepto_usuario_sel');
...
VALUES (1, 1, E'2012-11-02 13:26:52', E'2012-12-19 18:00:08.498', E'activo', 1, E'Hr.', 'Hora', E'Tiempo');
INSERT INTO param.tunidad_medida ("id_usuario_reg", "id_usuario_mod", "fecha_reg", "fecha_mod", "estado_reg", "id_unidad_medida", "codigo", "descripcion", "tipo")
VALUES (1, 1, E'2012-11-02 13:29:13', E'2012-12-19 18:00:55.574', E'activo', 2, E'dia', 'Día', E'Tiempo');
INSERT INTO param.tunidad_medida ("id_usuario_reg", "id_usuario_mod", "fecha_reg", "fecha_mod", "estado_reg", "id_unidad_medida", "codigo", "descripcion", "tipo")
VALUES (1, 1, E'2012-11-02 13:34:20', E'2012-12-19 18:01:24.560', E'activo', 3, E'sem', 'Semana', E'Tiempo');
INSERT INTO param.tunidad_medida ("id_usuario_reg", "id_usuario_mod", "fecha_reg", "fecha_mod", "estado_reg", "id_unidad_medida", "codigo", "descripcion", "tipo")
VALUES (1, 1, E'2012-11-02 13:29:13', E'2012-12-19 18:50:36.757', E'activo', 4, E'mes', 'Mes', E'Tiempo');
INSERT INTO param.tunidad_medida ("id_usuario_reg", "id_usuario_mod", "fecha_reg", "fecha_mod", "estado_reg", "id_unidad_medida", "codigo", "descripcion", "tipo")
