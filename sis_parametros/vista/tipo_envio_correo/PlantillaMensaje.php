...
Phx.vista.PlantillaMensaje=Ext.extend(Phx.frmInterfaz,{
    ActSave:'../../sis_parametros/control/TipoEnvioCorreo/modificarPlantillaCorreo',
        ...
        this.Grupos= [
                   {
                    ...
                    items: [
                           ...
                           },
                           {
                               xtype:'panel',
                               width:'20%',
                               html:'<b><h2>Variables</h2></b> ** Verificar que las variables que referencian a la tabla existan  EJM {$tabla.desc_proveedor}'
    ...
    {       
        ...
        this.Cmp.id_tipo_envio_correo.setValue(this.data.id_tipo_envio_correo);
