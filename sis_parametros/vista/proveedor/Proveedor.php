...
<script>
    Phx.vista.proveedor=Ext.extend(Phx.gridInterfaz,{
        ...
        constructor:function(config){
            ...
            this.addButton('estadoProveedor',{
                text: 'Autorizacion',
                iconCls: 'blist',
                disabled: false,
                handler:
                this.mostarFormAuto,
                tooltip: '<b>Estado Proveedor</b>'
            });
            this.crearFormAuto();
        ...
        Atributos:[
            ...
            },
            {
                ...
                type:'TextField',
                filters:{pfiltro:'provee.autorizacion',type:'string'},
                id_grupo:1,
                grid:true,
                form:false
            },
        ...
        mostarFormAuto:function(){
            ...
            if(data){
                this.cmpAuto.setValue(data.autorizacion);
                this.wAuto.show();
            }
        ...
        crearFormAuto:function(){
            var storeCombo = new Ext.data.JsonStore({
                ...
                fields: ['id_catalogo','codigo','descripcion'],
                remoteSort: true,
                baseParams: {par_filtro: 'descripcion', cod_subsistema : 'PARAM',catalogo_tipo :'tproveedor_autorizacion'}
            });
        ...
        saveAuto: function(){
            ...
            Phx.CP.loadingShow();
            Ext.Ajax.request({
                url: '../../sis_parametros/control/Proveedor/estadoProveedor',
                params: {
