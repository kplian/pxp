...
class MODDeptoUsuario extends MODbase{
	...
	function listarDeptoUsuario(){
		...
		$this->procedimiento='param.f_tdepto_usuario_sel';
		$this->transaccion='PM_DEPUSU_SEL';
	...
	function insertarDeptoUsuario(){
		...
		$this->procedimiento='param.f_tdepto_usuario_ime';
		$this->transaccion='PM_DEPUSU_INS';
	...
	function modificarDeptoUsuario(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='param.f_tdepto_usuario_ime';
		$this->transaccion='PM_DEPUSU_MOD';
		$this->tipo_procedimiento='IME';
	...
	function eliminarDeptoUsuario(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='param.f_tdepto_usuario_ime';
		$this->transaccion='PM_DEPUSU_ELI';
		$this->tipo_procedimiento='IME';
