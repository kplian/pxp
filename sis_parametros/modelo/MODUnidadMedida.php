...
class MODUnidadMedida extends MODbase{
	...
	function listarUnidadMedida(){
		...
		$this->procedimiento='param.f_unidad_medida_sel';
		$this->transaccion='PM_UME_SEL';
	...
	function insertarUnidadMedida(){
		...
		$this->procedimiento='param.f_unidad_medida_ime';
		$this->transaccion='PM_UME_INS';
