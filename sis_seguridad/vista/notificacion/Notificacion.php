...
/**
*@package pXP
*@file Notificacion.php
*@author KPLIAN (admin)
*@date 14-02-2011
*@description  Vista para configurar notificaciones
*/
...
Phx.vista.notificacion=Ext.extend(Phx.gridInterfaz,{
	...
	constructor: function(config){
		...
		Phx.vista.notificacion.superclass.constructor.call(this,config);


		this.init();
		
		this.addButton('noti_verificada',{text:'Verificado',icon: '../../../lib/imagenes/ok.png',disabled:true,handler:noti_verificada,tooltip: '<b>Presione si la notificación ya ha sido verificada</b>'});
	...
	preparaMenu:function(tb){
		...
		Phx.vista.notificacion.superclass.preparaMenu.call(this,tb);
		return tb;
	},
	liberaMenu:function(tb){
		this.getBoton('noti_verificada').disable();
		Phx.vista.notificacion.superclass.liberaMenu.call(this,tb);
		return tb;
	}	
