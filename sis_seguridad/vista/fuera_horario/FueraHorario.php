...
/**
*@package pXP
*@file FueraHorario.php
*@author KPLIAN (admin)
*@date 14-02-2011
*@description  Vista para configurar los horarios no laborales o comunes
*/
...
Phx.vista.fuera_horario=function(config){
	...
	Phx.vista.fuera_horario.superclass.constructor.call(this,config);
	this.init();
...
Ext.extend(Phx.vista.fuera_horario,Phx.gridInterfaz,{
	
	title:'Log',
	ActList:'../../sis_seguridad/control/Log/listarLogHorario',
	...
	preparaMenu:function(tb){
		...
		Phx.vista.fuera_horario.superclass.preparaMenu.call(this,tb);
