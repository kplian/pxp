...
<a href="https://endetransmision.atlassian.net/servicedesk/customer/portals" target="_blank" class="boton5" title="Solicita Apoyo" style="">
    <i class="fa fa-wrench my-float" style="margin-top:10px;"></i>
</a>
</body>
</html>
