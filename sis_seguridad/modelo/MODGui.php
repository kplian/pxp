...
class MODGui extends MODbase {
	...
	* que se encuentra a la izquierda en la pantalla*/
	...
	function listarMenu(){
		...
		$this->setProcedimiento('segu.ft_menu_sel');
		$this->setTransaccion('SEG_MENU_SEL');
	...
	function listarGui(){
		...
		$this->setTransaccion('SEG_GUI_SEL');
		$this->setTipoProcedimiento('SEL');
	...
	function getGui(){
		...
		$this->setProcedimiento('segu.ft_gui_sel');
		$this->setTransaccion('SEG_GETGUI_SEL');
		$this->setTipoProcedimiento('SEL');
	...
	function listarGuiSincronizacion(){
		...
		$this->setProcedimiento('segu.ft_gui_sel');
		$this->setTransaccion('SEG_GUISINC_SEL');
		$this->setTipoProcedimiento('SEL');
	...
	function insertarGui(){
		...
		$this->setProcedimiento('segu.ft_gui_ime');// nombre procedimiento almacenado
		$this->setTransaccion('SEG_GUI_INS');//nombre de la transaccion
	...
	function modificarGui(){
		...
		//Definicion de variables para ejecucion del procedimiento
		$this->setProcedimiento('segu.ft_gui_ime');// nombre procedimiento almacenado
		$this->setTransaccion('SEG_GUI_MOD');//nombre de la transaccion
		$this->setTipoProcedimiento('IME');//tipo de transaccion
	...
	function eliminarGui(){
		...
		$this->setProcedimiento('segu.ft_gui_ime');
		$this->setTransaccion('SEG_GUI_ELI');
	...
	function guardarGuiDragDrop(){
		//Definicion de variables para ejecucion del procedimientp
		$this->setProcedimiento('segu.ft_gui_ime');
		$this->setTransaccion('SEG_GUIDD_IME');
		$this->setTipoProcedimiento('IME');
	...
	function guardarGuiSincronizacion(){
		...
		//Definicion de variables para ejecucion del procedimientp
		$this->setProcedimiento('segu.ft_gui_ime');
		$this->setTransaccion('SEG_GUISINC_IME');
		$this->setTipoProcedimiento('IME');
