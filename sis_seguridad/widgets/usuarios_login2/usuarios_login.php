...
Ext.define('Phx.vista.widget.UsuariosLogin',{		
	...
	constructor: function(config){
		  ...
		  this.panel.add({
				           ...
				           autoScroll : true,
				           text: 'Loading...',
		                   html : 	'<iframe id:"iframe" src="../../../sis_seguridad/widgets/usuarios_login2/index.html"  scrolling="no"  align="center" width = "100%" height="400px" frameborder="0" onload="resizeIframe(this)"></iframe>'
