...
-- Data for table segu.tpersona (OID = 306441) (LIMIT 0,1)
--
...
select pxp.f_insert_tfuncion ('ft_regional_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_rol_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_subsistema_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('function1', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_proyecto_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_rol_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_rol_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_gui_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_tipo_documento_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_proyecto_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_actividad_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_funcion_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_log_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_procedimiento_gui_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_sesion_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('f_verif_eliminado', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_menu_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_sesion_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('f_t_persona_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_clasificador_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_clasificador_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_actividad_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_rol_procedimiento_gui_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_validar_usuario_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_gui_rol_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_rol_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_gui_rol_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_subsistema_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_procedimiento_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ftrig_log', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_procedimiento_gui_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_gui_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_funcion_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_estructura_dato_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_rol_procedimiento_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('f_permiso_rol', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_estructura_gui_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_regional_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_proyecto_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_regional_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_estructura_dato_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_estructura_gui_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_proyecto_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_actividad_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_primo_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_persona_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_usuario_actividad_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_procedimiento_ime', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('ft_persona_sel', 'Funcion para tabla', 'SEGU');
select pxp.f_insert_tfuncion ('f_actualizar_log_bd', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_actualizar_sesion', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_monitorear_recursos', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_bloqueo_notificacion_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_bloqueo_notificacion_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_ep_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_ep_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_programa_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_programa_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_horario_trabajo_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_horario_trabajo_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_monitor_bd_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_patron_evento_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_patron_evento_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_configurar_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_get_id_usuario', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_actualiza_persona_entre_bd', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_importar_menu', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_regional_sel', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_grant_all_privileges', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_sincroniza_persona_entre_bd', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('f_sincroniza_usuario_entre_bd', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_libreta_her_ime', 'Funcion para tabla     ', 'SEGU');
select pxp.f_insert_tfuncion ('ft_libreta_her_sel', 'Funcion para tabla     ', 'SEGU');
...
', 'si', '', '', 'ft_log_sel');
select pxp.f_insert_tprocedimiento ('SEG_LOGHOR_CONT', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_log_sel');
select pxp.f_insert_tprocedimiento ('SEG_PROGUI_INS', '	Inserta Procedimiento_Gui
', 'si', '', '', 'ft_procedimiento_gui_ime');
...
', 'si', '', '', 'ft_clasificador_sel');
select pxp.f_insert_tprocedimiento ('SEG_ROL_SEL', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_rol_sel');
select pxp.f_insert_tprocedimiento ('SEG_SUBSIS_SEL', '	Listado de los subsistemas registradas del sistema
', 'no', '', '', 'ft_subsistema_sel');
...
', 'si', '', '', 'ft_bloqueo_notificacion_sel');
select pxp.f_insert_tprocedimiento ('SEG_HORTRA_INS', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_horario_trabajo_ime');
select pxp.f_insert_tprocedimiento ('SEG_HORTRA_MOD', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_horario_trabajo_ime');
select pxp.f_insert_tprocedimiento ('SEG_HORTRA_ELI', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_horario_trabajo_ime');
select pxp.f_insert_tprocedimiento ('SEG_HORTRA_SEL', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_horario_trabajo_sel');
select pxp.f_insert_tprocedimiento ('SEG_HORTRA_CONT', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_horario_trabajo_sel');
select pxp.f_insert_tprocedimiento ('SEG_MONESQ_SEL', '	Listado de registros del monitor de objetos de bd (Esquemas)
', 'si', '', '', 'ft_monitor_bd_sel');
...
', 'si', '', '', 'ft_usuario_proyecto_ime');
select pxp.f_insert_tprocedimiento ('SEG_USUPRO_MOD', 'Modifica la relacion de proyectos con usuario
', 'si', '', '', 'ft_usuario_proyecto_ime');
select pxp.f_insert_tprocedimiento ('SEG_ROL_CONT', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_rol_sel');
...
', 'si', '', '', 'ft_monitor_bd_sel');
select pxp.f_insert_tprocedimiento ('SEG_PATEVE_ELI', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_patron_evento_ime');
select pxp.f_insert_tprocedimiento ('SEG_PATEVE_SEL', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_patron_evento_sel');
select pxp.f_insert_tprocedimiento ('SEG_PATEVE_CONT', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_patron_evento_sel');
select pxp.f_insert_tprocedimiento ('SG_CONF_MOD', '	Configuración de cuenta de usuario
 	', 'si', '', '', 'ft_configurar_ime');
select pxp.f_insert_tprocedimiento ('SG_LIB_INS', '	Insercion de registros
 	', 'si', '', '', 'ft_libreta_her_ime');
...
', 'si', '', '', 'ft_persona_sel');
select pxp.f_insert_tprocedimiento ('SEG_PATEVE_INS', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_patron_evento_ime');
select pxp.f_insert_tprocedimiento ('SEG_PATEVE_MOD', 'CODIGO NO DOCUMENTADO', 'si', '', '', 'ft_patron_evento_ime');
...
', 'si', '', '', 'ft_rol_procedimiento_gui_sel');
