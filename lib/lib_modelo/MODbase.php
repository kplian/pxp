    ...
    function setParametro($nombre,$valor,$tipo,$blank=true,$tamano='',$opciones=null,$tipo_archivo=null){
        ...
        if($this->esMatriz){
            ...
            foreach ($this->arreglo as $row){
                 ...
                 //#133
                 if($tipo == 'texto_ampliado'){
					$row[$valor]=pg_escape_string($row[$valor]);
                 } else {
            ...
            {    if(isset($this->arreglo_consultas[$valor])){
                ...
                if(isset($this->arreglo[$valor])) {
                    ...
                    if($tipo=='bytea') {
                        ...
                        if($tipo == 'texto_ampliado') { //#133 texto ampliado para guardar comilla simple son forzar que se duplique
						  $this->arreglo[$valor]=pg_escape_string($this->arreglo[$valor]);
						} else{
