...
Ext.ux.grid.RowEditor = Ext.extend(Ext.Panel, {
        ...
        if(this.el && (this.isVisible() || force === true)){
            ...
            for(var i = 0, len = cm.getColumnCount(); i < len; i++){
                if(!cm.isHidden(i)){
                    ...
                    position[i] = cm.getColumnWidth(i) - adjust;
                    fields[i].setWidth(position[i]);
                    fields[i].show();
            ...
            //this.getLayout().updateChildBoxes(position);
            this.doLayout();
            this.positionButtons();
            console.log('recalcula ancho')
        }
    },
    ...
    initFields: function(){
        ...
        for(var i = 0, len = cm.getColumnCount(); i < len; i++){
            ...
            if(i == 0){
                ed.margins = pm('1 1 2 1');
            } else if(i == len - 1){
                ed.margins = pm('1 1 2 1');
            } else{
                if (Ext.isIE) {
                    ed.margins = pm('1 0 2 0');
                }
                else {
                    ed.margins = pm('1 1 2 0');
                }
            }
