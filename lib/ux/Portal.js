...
Ext.ux.Portal = Ext.extend(Ext.Panel, {
    ...
    initComponent : function(){
        ...
        this.on('resize',function(obj, adjWidth, adjHeight, rawWidth, rawHeight){
        	
        	 var me = this;
        	 me.items.items.forEach(function(columna) {	
        	 	console.log('....columnas', columna)		    	  	
			    	columna.items.items.forEach(function(entry) {
			    		console.log('....entry', entry)	
			    	    if(entry.maximized){
			    	    	console.log('.... 	maximized ', entry)	
			    	    	entry.restore()
			    	    } 			    		
			    	});
			    });
