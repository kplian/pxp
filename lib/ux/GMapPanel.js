...
Ext.ux.GMapPanel = Ext.extend(Ext.Panel,{
	...
	constructor:function(config){
        ...
        Ext.apply(this.mapConfig,config.mapConfig);
	     ...
	     if( typeof google!= 'undefined' ){
	      	...
	      	this.center = new google.maps.LatLng(18.2, -66.4);
	      ...
	      //this.gmap.setCenter(new google.maps.LatLng(18.2, -66.4)) 
	       ...
	       // if (typeof this.setCenter === 'object') {
	       	...
	       	// }
	            ...
	            google.maps.event.bind(this.gmap, 'tilesloaded', this,function(){this.onMapReady();});
	         }
    },
    onMapReady : function(){
    ...
    onResize : function(w, h){
        ...
        Ext.ux.GMapPanel.superclass.onResize.call(this, w, h);
         ...
         if (typeof google!= 'undefined' && typeof this.getMap() == 'object') {
