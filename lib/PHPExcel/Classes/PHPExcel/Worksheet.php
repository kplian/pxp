    ...
    private static function _checkSheetTitle($pValue)
    {
        ...
        if (str_replace(self::$_invalidCharacters, '', $pValue) !== $pValue) {
		 ...
		 //return str_replace(self::$_invalidCharacters, '', $pValue);
		  ...
		  throw new PHPExcel_Exception('Invalid character found in sheet title ...'.str_replace(self::$_invalidCharacters, '', $pValue));
        }

        // Maximum 31 characters allowed for sheet title
        if (PHPExcel_Shared_String::CountCharacters($pValue) > 31) {
            throw new PHPExcel_Exception('Maximum 31 characters allowed in sheet title....'.$pValue);
        }
