...
Ext.lib.Ajax = function() {
    ...
    var pub = {
        request : function(method, uri, cb, data, options) {
           ...
           //RAC	
    	//MODIFICACION DEL LA CLASE JAVA PARA PHX
    	//Autor:      Rensi Arteaga Copari
    	//Proposito:  Centralizar todas las llamadas asincronas 
    	//            y cifrar todos los parametros enviados al servidor
    	//fecha:      03/07/2010
    	
    	 var params = Ext.urlDecode(data);
    	 
    	
         
         if(params._tipo!='direc'){
      	   
      	    //23/09/2015
      	    //codificar variable de filtros en combos
      		/*jrr ahora se codifica todos los parametros
      		if(params.query && params.par_filtro){
      		...
      		//URL de la clase que centraliza todas las solicitudes en el servidor 
             ...
             /*fin jrr*/
      		mat=1;
      		//pregunta si la encriptacion esta habilitada
      		if( typeof Phx != 'undefined'){
	      		if(Phx.CP.config_ini.x==1){
	      			
	      			data=Phx.CP.CRIPT.Encriptar(data);
	      			uri=Phx.CP.CRIPT.Encriptar(uri);
	      			if(params._tipo=='matriz'){
	      			   mat=Phx.CP.CRIPT.Encriptar('1');
	      			}
	      		}	
      		}
      		
      		
      		//preapara la url codificada y la manda en la variable x
      		//los datos van en la variable p en formato json
      		data='x='+uri+'&p='+data;
      		//pregunta si los datos seran enviados como matriz
      		if(params._tipo=='matriz'){
      			data=data+'&m='+mat;
      			
      		}

      		//cambia la url, por la direccion del intermediario
      		uri='../../../lib/lib_control/Intermediario.php'
