...
Ext.calendar.EventEditWindow = function(config) {
	...
	console.log(  'TITLEEEEEEEEE', this.idCalendar+'-title')
	
	this.idCalendar = Ext.id();
    ...
    var formPanelCfg = {
        ...
        },
        {
            ...
            id: this.idCalendar+'-date-range',
            anchor: '100%',
            fieldLabel: 'When'
        }]
    };
    
    console.log('idtmp',this.idCalendar)
    var idtmp = this.idCalendar+'-calendar';
...
Ext.extend(Ext.calendar.EventEditWindow, Ext.Window, {
    ...
    afterRender: function() {
       ...
       //RAC aumenta concatenacion con el id 
        this.el.addClass(this.id + '-ext-cal-event-win');


       //RAC    FORMULARIO  TRASERO
...
/*
    ...
    show: function(o, animateTarget) {
        ...
        function() {
        	...
        	console.log('tituloooooooooo' ,this.id)
        	
            Ext.getCmp(this.idCalendar+'-title').focus(false, 100);
        });
...
var idtmp = this.idCalendar+'-calendar';
        ...
        if (this.calendarStore) {
            ...
            Ext.getCmp(idtmp).setValue(rec.data[Ext.calendar.EventMappings.CalendarId.name]);
        }
        
        Ext.getCmp(this.idCalendar+'-date-range').setValue(rec.data);
    ...
    updateRecord: function() {
        ...
        dates = Ext.getCmp(this.idCalendar+'-date-range').getValue(),
