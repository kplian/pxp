 ...
 */
    ...
    loadValoresIniciales: function() {
        ...
        this.getValidComponente(0).focus();
                    ...
                    if (this.tipoInterfaz == 'gridInterfaz') {
                        ...
                        if (ac.grid) {
                            ...
                            if(ac.type == 'MoneyField' && !ac.config.renderer){
                            	console.log('currencyChar',ac.config.currencyChar)	ac.config.renderer=Ext.util.Format.CurrencyFactory(2, ",", ".", ac.config.currencyChar , false);
                            }
