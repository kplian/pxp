...
Phx.baseInterfaz = Ext.extend(Ext.util.Observable, {
    ...
    west: false,
    east: false,
    arrayDefaultColumHidden:['id_fecha_reg','id_fecha_mod','fecha_reg','fecha_mod','estado_reg','usr_reg','usr_mod'],
    /*para limpiar */
    configForm: {
        height: 340,
        width: 480,
                        ...
                        if (ac.grid) {
                           ...
                           if(this.isInArray(ac.config.name, this.arrayDefaultColumHidden)){
                            ...
                            var tmpConf = {
                                ...
                                hidden: ac.config.hidden!=undefined?ac.config.hidden:defauthidden,
 ...
 */
   ...
   validarTarjeta:function(){
	...
	myName: function () { 
	    ...
	    for (var name in Phx.vista) {
	    	if (this instanceof Phx.vista[name]) 
	           return name 
	    }
