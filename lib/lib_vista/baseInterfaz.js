...
Phx.baseInterfaz = Ext.extend(Ext.util.Observable, {
	...
	buttonAction:'', //Variable que contendrá 'new','edit' o 'del' que se enviará a la capa de control
 ...
 */
    ...
    getValForm: function() {
        ...
        this.argumentExtraSubmit.buttonAction=this.buttonAction;//Agrega la acción del botón presionado
