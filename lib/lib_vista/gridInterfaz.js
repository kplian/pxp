...
Phx.gridInterfaz=Ext.extend(Phx.baseInterfaz,{
   ...
   constructor: function(config){
		...
		//#140
		this.grid.on('sortchange',function(obj, sortInfo){
		    var ind = me.getIndAtributoByDisplayField(sortInfo.field)
		    if(ind) {
               sortInfo.field = (!!me.Atributos[ind].config.sortField)?me.Atributos[ind].config.sortField : sortInfo.field;
		    }
		});
