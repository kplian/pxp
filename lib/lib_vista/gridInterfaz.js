...
Phx.gridInterfaz=Ext.extend(Phx.baseInterfaz,{
	...
	aplicarPltGrilla: function() {	//#24	
		...
		if(selectPltValue){
			...
			console.log('valor recuperado',state)
	...
	guardarPltGrilla: function() {//#24
		...
		console.log('guardar state', state);
   ...
   constructor: function(config){
		...
		this.eventinitPltGrid();//#24inicia los eventos para el combo de plantilla grilla
