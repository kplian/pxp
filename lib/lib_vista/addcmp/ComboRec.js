			    			 ...
			    			 name:'id_persona',
				   			 fieldLabel:'Persona',
				   				...
				   				store: new Ext.data.JsonStore({
									...
									totalProperty: 'total',
									fields: ['id_persona','nombre_completo1','ci','nombre','ap_paterno','ap_materno','correo','celular1','telefono1','telefono2','celular2'],
			         ...
			         //RAC 30112011
			    		...
			    		configini=	{
			    			        ...
			    			        tasignacion:false,
					   				...
					   				store: new Ext.data.JsonStore({
					                     url:config.url?config.url:'../../sis_parametros/control/Depto/listarDeptoCombo',
										id: 'id_depto',
										root: 'datos',
										sortInfo:{
											field: 'deppto.nombre',
				         ...
				         name:'ic_centro_costo',
			   			 fieldLabel:'Centro de Costos',
			   				...
			   				store: new Ext.data.JsonStore({
		    					...
		    					totalProperty: 'total',
		    					fields: ['id_centro_costo','codigo_cc','codigo_uo','ep','gestion','nombre_uo','nombre_actividad'],
		    					// turn on remote sorting
		    					remoteSort: true,
		    					baseParams:Ext.apply({par_filtro:'codigo_cc#nombre_uo#nombre_uo#nombre_actividad'},config.baseParams)
		    					
		    				}), 
		    				tpl:'<tpl for="."><div class="x-combo-list-item"><p>Gestion:{gestion}</p><p>UO:{nombre_uo}</p><p>Actividad:{nombre_actividad}</p><p>EP:{ep}</p></div></tpl>',    				
