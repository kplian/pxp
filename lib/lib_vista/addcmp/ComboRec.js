				         ...
				         name:'id_centro_costo',
			   			 fieldLabel:'Centro de Costos',
			   				...
			   				store: new Ext.data.JsonStore({
		    					...
		    					// turn on remote sorting
		    					remoteSort: true,
		    					baseParams:Ext.apply({tipo_pres:"gasto,administrativo,recurso,ingreso_egreso",par_filtro:'id_centro_costo#codigo_cc#codigo_uo#nombre_uo#nombre_actividad#nombre_programa#nombre_proyecto#nombre_regional#nombre_financiador'},config.baseParams)
