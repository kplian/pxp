			    			 ...
			    			 name:'id_persona',
				   			 fieldLabel:'Persona',
				   				...
				   				store: new Ext.data.JsonStore({
									...
									totalProperty: 'total',
									fields: ['id_persona','nombre_completo1','ci','nombre','ap_paterno','ap_materno','correo','celular1','telefono1','telefono2','celular2',{name:'fecha_nacimiento', type: 'date', dateFormat:'Y-m-d'},'genero'],
