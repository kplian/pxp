			    		...
			    		configini={
					         ...
					         name:'id_proveedor',
				   			 ...
				   			 store: new Ext.data.JsonStore({
									...
									totalProperty: 'total',
									fields: ['id_proveedor','desc_proveedor','codigo','nit','rotulo_comercial','lugar'],
									// turn on remote sorting
									remoteSort: true,
				   			  ...
				   			  tpl:'<tpl for="."><div class="x-combo-list-item"><p>{codigo}</p><p><b>{rotulo_comercial}</b></p><p>{desc_proveedor}</p><p>NIT:{nit}</p><p>Lugar:{lugar}</p></div></tpl>',
				         ...
				         name:'id_centro_costo',
			   			 fieldLabel:'Centro de Costos',
			   				...
			   				store: new Ext.data.JsonStore({
		    					...
		    					// turn on remote sorting
		    					remoteSort: true,
		    					baseParams:Ext.apply({tipo_pres:2,par_filtro:'id_centro_costo#codigo_cc#codigo_uo#nombre_uo#nombre_actividad#nombre_programa#nombre_proyecto#nombre_regional#nombre_financiador'},config.baseParams)
		    					
		    				}), 
		    				tpl:'<tpl for="."><div class="x-combo-list-item"><p><b>UO: {nombre_uo} </b></p><p>Gestion: {gestion}</p><p>Reg: {nombre_regional}</p><p>Fin.: {nombre_financiador}</p><p>Proy.: {nombre_programa}</p><p>Act.: {nombre_actividad}</p><p>{codigo_cc}</p></div></tpl>',    				
