			    		...
			    		configini={
					         ...
					         name:'id_proveedor',
				   			 ...
				   			 store: new Ext.data.JsonStore({
									...
									totalProperty: 'total',
									fields: ['id_proveedor','desc_proveedor','codigo','nit','rotulo_comercial'],
									// turn on remote sorting
									remoteSort: true,
				   			  ...
				   			  tpl:'<tpl for="."><div class="x-combo-list-item"><p>{codigo}</p><p><b>{rotulo_comercial}</b></p><p>{desc_proveedor}</p><p>NIT:{nit}</p> </div></tpl>',
		    	...
		    	if(config.origen=='CENTROCOSTO'){    		
		    		...
		    		configini={
				         ...
				         name:'id_centro_costo',
		    				...
		    				tpl:'<tpl for="."><div class="x-combo-list-item"><p>Gestion:{gestion}</p><p>UO:{nombre_uo}</p><p>Reg:{nombre_regional}</p><p>Fin.:{nombre_financiador}</p><p>Proy.:{nombre_programa}</p><p>Act.:{nombre_actividad}</p><b><p>{codigo_cc}</p></b></div></tpl>',    				
