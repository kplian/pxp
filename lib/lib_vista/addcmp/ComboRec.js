				         ...
				         name:'id_centro_costo',
			   			 fieldLabel:'Centro de Costos',
			   				...
			   				store: new Ext.data.JsonStore({
		    					...
		    					// turn on remote sorting
		    					remoteSort: true,
		    					baseParams:Ext.apply({par_filtro:'codigo_cc#nombre_uo#nombre_uo#nombre_actividad#nombre_programa#nombre_proyecto#nombre_regional#nombre_financiador'},config.baseParams)
		    					
		    				}), 
		    				tpl:'<tpl for="."><div class="x-combo-list-item"><p>Gestion:{gestion}</p><p>UO:{nombre_uo}</p><p>Reg:{nombre_regional}</p><p>Fin.:{nombre_financiador}</p><p>Proy.:{nombre_programa}</p><p>Act.:{nombre_actividad}</p><b><p>EP:{ep}</p></b></div></tpl>',    				
