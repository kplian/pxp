				         ...
				         name:'ic_centro_costo',
			   			 fieldLabel:'Centro de Costos',
			   				...
			   				store: new Ext.data.JsonStore({
		    					...
		    					totalProperty: 'total',
		    					fields: ['id_centro_costo','codigo_cc','codigo_uo','ep','gestion'],
		    					// turn on remote sorting
		    					remoteSort: true,
		    					baseParams:Ext.apply({par_filtro:'codigo_cc#nombre_uo#ep'},config.baseParams)
		    					
		    				}), 
		    				tpl:'<tpl for="."><div class="x-combo-list-item"><p>Gestion:{gestion}</p><p>UO:{codigo_uo}</p><p>EP:{ep}</p></div></tpl>',    				
