...
class TCPDF {
	...
	public function AddPage($orientation='', $format='', $keepmargins=false, $tocpage=false) {
		...
		//echo 'yplb: '.$orientation.'-'.$format.'-'.$tocpage;exit;
		// start new page
	...
	/*public function Header() {
		...
		$this->SetX($header_x);
		$this->MultiCell($ancho_celda, $cell_height, $headerdata['title'], 0, '', 1, 1, '', '', false, 0, false);
		$tituloy=$this->getY();
		$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]);
		$this->SetXY($header_x+$ancho_celda,$inity);
		$this->MultiCell($ancho_celda, $cell_height, $headerdata['string'], 0, '', 1, 1, '', '', false, 0, false);
	...
	public function Header() {
		...
		// header string
		$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]);
		$this->SetX($header_x);//var_dump($headerdata);exit;
	...
	protected function setHeader() { 
		if ($this->print_header) {
			...
			$this->SetFont($this->header_font[0], $this->header_font[1], $this->header_font[2]);//echo 'yplb.dpd';exit;
			$this->Header();//echo 'yplb.dpd';exit;
			//restore position
			if ($this->rtl) {
