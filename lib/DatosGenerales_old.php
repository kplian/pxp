...
// Esta es la variable que indica el host del servidor Postgres
	...
	$_SESSION["_CONTRASENA_CONEXION"]	= "dbadqui_conexion" ;
	...
	*/
	...
	$_SESSION['_TITULO_SIS_CORTO']=" DESARROLLO Ã